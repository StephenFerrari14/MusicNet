  ...
  <title>
    ...
    $(document).ready(function(){
	 ...
	 oTable = $('#datatable').dataTable( {
        "aaData": [
          [ "Ryan's Opera","3:00", "FR", "Ryan^2", 4, 2],
	...
	<?php 
		...
		$query = "UPDATE Play P SET P.play_count = P.play_count + 1 WHERE P.user_id = 'david_kelly6' AND P.song_id = '".$input."';";
	...
	<br>
      <div>
		...
		Now Playing: <p id="played-song" style="display:inline"></p>
